...
config_list_gpt_prev = autogen.config_list_from_json(
...
# LLM_CONFIG_LIST.json is needed! Check the Autogen repo for more info!
...
gpt_prev_config = {
    ...
    "temperature": 0.7,
    "top_p" : 1.0,
    "config_list": config_list_gpt_prev,
    "timeout": 600,
}
...
gpt_json_config = deepcopy(gpt_prev_config)
gpt_json_config["temperature"] = 0.7
gpt_json_config["config_list"][0]["response_format"] = { "type": "json_object" }

gpt_json_engineer_config = deepcopy(gpt_prev_config)
gpt_json_engineer_config["temperature"] = 0.0
gpt_json_engineer_config["config_list"][0]["response_format"] = { "type": "json_object" }
...
def create_agents(no_of_objects : int):
    ...
    engineer = autogen.AssistantAgent(
        name = "Engineer",
        llm_config = gpt_json_engineer_config,
        human_input_mode = "NEVER",
        is_termination_msg = is_termination_msg,
