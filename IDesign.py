...
from agents import is_termination_msg, gpt_config
...
class IDesign:
    ...
    def create_initial_design(self):
        ...
        manager = GroupChatManager(groupchat=groupchat, llm_config=gpt_config, is_termination_msg=is_termination_msg)
